...
const IMG = {
  ...
  thali: "https://images.unsplash.com/photo-1601050690597-df0568f70950?auto=format&fit=crop&w=900&q=80",
  ...
  dessert: "https://images.unsplash.com/photo-1571115177098-24ec42ed204d?auto=format&fit=crop&w=900&q=80"
};

const MENU: MenuItem[] = [
  { id:1, name:"Aloo Paratha", category:"Breakfast", price:90, description:"Crisp wheat paratha with spiced potato filling, served with curd.", vegetarian:true, image:IMG.thali },
  { id:2, name:"Masala Chai", category:"Beverages", price:40, description:"Fragrant Indian tea simmered with milk and warming spices.", vegetarian:true, image:IMG.dessert },
  ...
  { id:4, name:"Dal Makhani", category:"Main Course", price:220, description:"Slow-cooked black lentils finished with butter and cream.", vegetarian:true, image:IMG.thali },
  { id:5, name:"Shahi Paneer", category:"Main Course", price:260, description:"Paneer in a rich, mildly spiced tomato and cashew gravy.", vegetarian:true, image:IMG.paneer },
  { id:6, name:"Butter Naan", category:"Breads", price:60, description:"Soft tandoor-baked naan brushed with butter.", vegetarian:true, image:IMG.interior },
  ...
  { id:8, name:"Gulab Jamun", category:"Desserts", price:80, description:"Warm milk dumplings soaked in fragrant cardamom syrup.", vegetarian:true, image:IMG.dessert },
  { id:9, name:"Tandoori Platter", category:"Starters", price:420, description:"Illustrative mixed vegetarian tandoor selection for the demo menu.", vegetarian:true, image:IMG.paneer },
  { id:10, name:"Jeera Rice", category:"Rice & Biryani", price:150, description:"Basmati rice tempered with cumin and whole spices.", vegetarian:true, image:IMG.biryani }
];
      ...
      <main>
        ...
        <section id="gallery" className="section">
          ...
          <div className="gallery">
            {[IMG.interior, IMG.thali, IMG.paneer, IMG.biryani, IMG.dessert, IMG.hero].map((src,i)=>
